...
<div class="card">
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${item.image!=null}">
                                <img src=${item.imageUrlForJSP} alt="wrong Image" width="100 "height="100"/>
                            </c:if>
                        </td>
        ...
        <a href="${pageContext.request.contextPath }/shopping/items/"><input class="btn btn-primary" type="submit"
                                                                             value="Search in items"/></a>
        <a href="${pageContext.request.contextPath }/shopping/login/logout"><input class="btn btn-primary" type="submit"
                                                                                   value="Logout"/></a>
    </div>
</div>
